...
import { Laptop, Building, MapPin, ArrowLeft, Calendar as CalendarIcon, Clock, User, Mail, Phone, Loader2, Globe, CreditCard, Banknote, ChevronsUpDown, Check, ExternalLink } from 'lucide-react';
