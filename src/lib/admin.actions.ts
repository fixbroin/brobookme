...
import { updateAdminSettings, getProviderByUsername, updateProvider, getPlan, getAdminSettings, getAllDocsFromCollection, setDocInCollection, getAllProviders as getAllProvidersData, addNotification } from './data';
import type { RazorpaySettings, SmtpSettings, SiteSettings, FaqItem, Testimonial, FooterSettings, ScreenshotsSettings, MarketingSettings, ServiceTypeSetting, PolicySettings, GoogleApiSettings, OutlookApiSettings, AboutSettings } from './types';
