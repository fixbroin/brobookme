            ...
            <div className="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center justify-between rounded-lg border p-4">
                         ...
                         <div className="flex items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                                <Label htmlFor="enable-animation">Enable Spin Animation</Label>
                                <p className="text-sm text-muted-foreground">
                                    Make the buttons spin slowly to attract attention.
                                </p>
                            </div>
                            <Switch
                                id="enable-animation"
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Set up the numbers, messages, and position for the buttons.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                         ...
                         <div className="space-y-2">
                            ...
                            >
                                <SelectTrigger id="button-position" className="w-[180px]">
