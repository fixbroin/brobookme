    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Set your local timezone and preferred date format.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Popover open={openTimezoneCombobox} onOpenChange={setOpenTimezoneCombobox}>
              <PopoverTrigger asChild>
                ...
                >
                  {settings.timezone
                    ? timezones.find((tz) => tz === settings.timezone)?.replace(/_/g, ' ')
                        ...
                        {timezones.map((tz) => (
                          <CommandItem
                            ...
                            onSelect={(currentValue) => {
                              const selectedTz = timezones.find(t => t.toLowerCase() === currentValue.toLowerCase()) || '';
                              handleSettingsChange('timezone', selectedTz);
           ...
           <div className="space-y-2">
              ...
              >
               ...
               <p className="text-sm text-muted-foreground">Choose how dates are displayed in your dashboard.</p>
            </div>
        </CardContent>
      </Card>
                  ...
                  {st.enabled && (
                    <div className="p-4 bg-muted/50 rounded-md space-y-4">
                      <div className="flex items-center justify-between">
                       ...
                       {st.priceEnabled && (
                         <div className="space-y-2">
                          <Label htmlFor={`service-price-${st.id}`}>Set Price (INR)</Label>
                          <Input 
