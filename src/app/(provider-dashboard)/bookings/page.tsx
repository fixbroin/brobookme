       ...
       <Dialog open={viewDialogState.open} onOpenChange={(open) => setViewDialogState({ open, booking: open ? booking : null })}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Appointment with {booking.customerName} on {formatInTimeZone(booking.dateTime, timezone, dateFormat)}.
              </DialogDescription>
            </DialogHeader>
                    ...
                    <div className="space-y-3 rounded-lg border bg-muted/50 p-4 mt-4">
                        ...
                        {isPaid && (
                            <>
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-medium">Paid ₹{payment.amount?.toLocaleString()} Online</span>
                                </div>
                                <div className="flex items-center gap-3">
                        ...
                        {isPayLater && (
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-medium">To be paid ₹{payment.amount?.toLocaleString()} after service</span>
                            </div>
                        )}
                        {isFree && (
                             <div className="flex items-center gap-3">
